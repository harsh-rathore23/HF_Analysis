...
public :
   ...
   vector<float>   *Z_Truth_e_Pt;                               
   vector<float>   *Z_Truth_e_Eta;                                   
   vector<float>   *Z_Truth_e_Phi;                                  
   vector<float>   *Z_Truth_e_E;                                 
   vector<float>   *Z_Truth_all_Pt;                                                          
   vector<float>   *Z_Truth_all_Eta;                                 
   vector<float>   *Z_Truth_all_Phi;                              
   vector<float>   *Z_Truth_all_E;                             
   vector<float>   *Z_Truth_no_pt_zero_Pt;               
   vector<float>   *Z_Truth_no_pt_zero_Eta;            
   vector<float>   *Z_Truth_no_pt_zero_Phi;       
   vector<float>   *Z_Truth_no_pt_zero_E;
   Float_t         rho;
   Int_t           run;
   Int_t           event;
   Int_t           lumi;
   ...
   TBranch        *b_Ele_Gen_E;   //!
   TBranch        *b_Z_Truth_e_Pt;          
   TBranch        *b_Z_Truth_e_Eta;         
   TBranch        *b_Z_Truth_e_Phi;         
   TBranch        *b_Z_Truth_e_E;           
   TBranch        *b_Z_Truth_all_Pt;        
   TBranch        *b_Z_Truth_all_Eta;       
   TBranch        *b_Z_Truth_all_Phi;       
   TBranch        *b_Z_Truth_all_E;         
   TBranch        *b_Z_Truth_no_pt_zero_Pt; 
   TBranch        *b_Z_Truth_no_pt_zero_Eta;
   TBranch        *b_Z_Truth_no_pt_zero_Phi;
   TBranch        *b_Z_Truth_no_pt_zero_E;
   TBranch        *b_rho;   //!
   TBranch        *b_run;   //!
   TBranch        *b_event;   //!
   TBranch        *b_lumi;   //!
...
void NtupleVariables::Init(TTree *tree)
{
   ...
   Z_Truth_all_Phi = 0;       
   Z_Truth_all_E = 0;         
   Z_Truth_no_pt_zero_Pt = 0; 
   Z_Truth_no_pt_zero_Eta = 0;
   Z_Truth_no_pt_zero_Phi = 0;
   Z_Truth_no_pt_zero_E = 0;
   ...
   fChain->SetBranchAddress("Z_Truth_e_Pt", &Z_Truth_e_Pt, &b_Z_Truth_e_Pt);
   fChain->SetBranchAddress("Z_Truth_e_Eta", &Z_Truth_e_Eta, &b_Z_Truth_e_Eta);
   fChain->SetBranchAddress("Z_Truth_e_Phi", &Z_Truth_e_Phi, &b_Z_Truth_e_Phi);
   fChain->SetBranchAddress("Z_Truth_e_E", &Z_Truth_e_E, &b_Z_Truth_e_E);
   fChain->SetBranchAddress("Z_Truth_all_Pt", &Z_Truth_all_Pt, &b_Z_Truth_all_Pt);
   fChain->SetBranchAddress("Z_Truth_all_Eta", &Z_Truth_all_Eta, &b_Z_Truth_all_Eta);
   fChain->SetBranchAddress("Z_Truth_all_Phi", &Z_Truth_all_Phi, &b_Z_Truth_all_Phi);
   fChain->SetBranchAddress("Z_Truth_all_E", &Z_Truth_all_E, &b_Z_Truth_all_E);
   fChain->SetBranchAddress("Z_Truth_no_pt_zero_Pt", &Z_Truth_no_pt_zero_Pt, &b_Z_Truth_no_pt_zero_Pt);
   fChain->SetBranchAddress("Z_Truth_no_pt_zero_Eta",&Z_Truth_no_pt_zero_Eta, &b_Z_Truth_no_pt_zero_Eta);
   fChain->SetBranchAddress("Z_Truth_no_pt_zero_Phi",&Z_Truth_no_pt_zero_Phi, &b_Z_Truth_no_pt_zero_Phi);
   fChain->SetBranchAddress("Z_Truth_no_pt_zero_E",  &Z_Truth_no_pt_zero_E, &b_Z_Truth_no_pt_zero_E);   
